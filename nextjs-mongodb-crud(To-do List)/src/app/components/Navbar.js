...
export default function Navbar() {
    ...
    return (
        <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-white bg-opacity-90 sticky top-0 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[5]">
                ...
                <div className="hidden lg:block">
                    <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                        ...
                        {session && session.user ? (
                            <li className="flex flex-cols gap-5">
                                {/* <Link onClick={() => signOut()} > */}
                                <p className="text-gray-600 hover:text-red-500 text-md text-center py-2 px-8 rounded-md w-max-10px">Hi, {session.user.name}</p>
                                <button onClick={() => signOut()} className="bg-red-600 hover:bg-red-500 text-white px-5 py-2 rounded-md">
                                    Sign out
                                </button>
                                {/* </Link> */}
                            </li>
