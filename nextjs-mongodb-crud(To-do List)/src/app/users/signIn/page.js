...
export default function SignIn() {
    ...
    return (
        <div className="grid grid-cols lg:grid-cols-2 gap-10  mx-auto m-20">
            {/* Login Form */}
            <div className="content-center text-center p-10 mx-auto mr-0 w-7/10">
                <div>
                ...
                <div className="mt-6">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="w-full">
                            <button type="submit" className="mx-auto bg-gray-800 w-full my-6 mx-6 py-2.5 px-4 text-xs font-medium text-center text-white rounded-md focus:ring-4 focus:ring-gray-200 dark:focus:ring-dark-900 hover:shadow-lg">
                                Sign In
                            </button>
                        </div>
                    </form>
                    <div className="flex items-center gap-3 rounded-full">
                        <input
                            ...
                            className="cursor-pointer w-5 h-5 bg-gray-100 border-gray-300 rounded-sm"
                        />
                        <label htmlFor="checkbox-table-4" className="cursor-pointer text-gray-500">Subscribe me to newsletter <a href="#" className="text-black">Forgot Password</a></label>
                    </div>
                </div>
                {/* Sign In with Social */}
                <div className="my-10 grid grid-col">
                    <button type="button" className="justify-center text-black shadow-md bg-white hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2">
                    ...
                    <p className="mt-3 text-gray-500">Not registered? <a href="/users/signUp" className="text-black font-bold">Create account</a></p>
                </div>
            </div>
